                            ...
                            <div className="carousel-item position-relative active" style={{ height: '430px' }}>
                                ...
                                <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div className="p-3" style={{ maxWidth: '1000px' }}>
                                        ...
                                        <p className="mx-md-5   animate__animated animate__bounceIn"> Roket, İHA ve özel parçalarınızı kaliteden ödün vermeden avantajlı fiyatlarla ürettirin. Uzman ekibimizle, en zorlu tasarımlarınızı hayata geçirin ve projelerinizi bir adım öne taşıyın.  </p>
                            ...
                            <div className="carousel-item position-relative" style={{ height: '430px' }}>
                                ...
                                <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div className="p-3" style={{ maxWidth: '1000px' }}>
                                        ...
                                        <p className="mx-md-5   animate__animated animate__bounceIn"> Her projenizin ihtiyaçlarını karşılayacak yüksek kaliteli parçaları kolayca ve hızlı bir şekilde temin edin. Geniş ürün yelpazemiz sayesinde projeleriniz için en uygun çözümleri bulabilirsiniz. </p>
                            ...
                            <div className="carousel-item position-relative" style={{ height: '430px' }}>
                                ...
                                <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                    <div className="p-3" style={{ maxWidth: '1000px' }}>
                                        ...
                                        <p className="mx-md-5  animate__animated animate__bounceIn">Projelerinizde güvenle kullanabileceğiniz yüksek kaliteli aviyonik kitler sunuyoruz. Güvenilir, hassas ve performans odaklı çözümlerimizle uçuş güvenliğinizi ve verimliliğinizi artırın.</p>
